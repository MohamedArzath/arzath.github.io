...
// Recipients
$fromEmail = 'support@easydoings.in'; // Email address that will be in the from field of the message.
$fromName = 'Arzath Portfolio'; // Name that will be in the from field of the message.
$sendToEmail = 'arzath.com@gmail.com'; // Email address that will receive the message with the output of the form
$sendToName = 'Mohamed Arzath'; // Name that will receive the message with the output of the form

// Subject
$subject = 'Message from Portfolio Site from '.$_POST['name'];
...
$smtpUsername = 'support@easydoings.in'; // SMTP username ie. gmail address
$smtpPassword = 'Arzath&123'; // SMTP password ie gmail password
...
$recaptchaSecret = '6LdRT3wrAAAAANxu0TAwlh_-m8YBELHkCxgVlt8H'; // enter your secret key from https://www.google.com/recaptcha/admin
